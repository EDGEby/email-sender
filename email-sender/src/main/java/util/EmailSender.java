...
//          message.setContent(msg, "text/html");
    ...
    public static void main( String[] args ) {
        ...
        String subj = "No spam!";
        String msg = "<a href='https://onliner.by'>SPAM!</a>";

        HTMLTableBuilder tableBuilder = new HTMLTableBuilder(
                "HTML Table" + msg,true,3,3,
                24,14,10);

        tableBuilder.addTableHeader("Company","Contact", "Country");
        tableBuilder.addRowValues("Alfred","Maria", "Germany");
        tableBuilder.addRowValues("CCM","Francisco", "Germany");

    //    send(FROM, subj, msg, "C:\\email-sender\\pom.xml");
        send(FROM, subj, tableBuilder.build(), "C:\\Users\\laman\\IdeaProjects\\email-sender\\pom.xml");
